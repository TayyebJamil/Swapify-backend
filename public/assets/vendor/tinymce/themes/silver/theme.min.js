...
!(function () {
  ...
  const M = Array.prototype.slice,
    ...
    $ = (e, t) => {
      for (let o = 0, n = e.length; o < n; o++) if (t(e[o], o)) return B.some(o)
      return B.none()
    },
    q = (e) => {
      const t = []
  ...
  const No = (e) => {
    ...
    qo = { value: Go, error: $o, fromOption: (e, t) => e.fold(() => $o(t), Go) }
  var Xo
  !(function (e) {
  ...
  const Ko = (e, t, o) => (e.stype === Xo.Error ? t(e.serror) : o(e.svalue)),
    ...
    kn = (e, t) => ({
      extract: (o, n) => {
        ...
        return (
          (i = (e) => {
            const s = P(e, (e) => tn(e, e, { tag: 'required', process: {} }, t))
  ...
  const dc = bs([
    ...
    vc = (e, t, o, n) => {
      const s = hc(Ht(e, t))
      return B.some(((e, t, o) => ({ point: e, width: t, height: o }))(s, o, n))
    },
    yc = (e, t, o, n, s) =>
      e.map((e) => {
        const r = [t, e.point],
    ...
    Sw = (e, t, o) => {
      ...
      return {
        ...
        behaviours: nu(e.sandboxBehaviours, [
          ...
          hl.config({
            channels: { ...zd({ isExtraPart: _ }), ...Pd({ doReposition: ww }) }
          })
        ])
      }
    },
        ...
        return {
          ...
          behaviours: tu(e.dropdownBehaviours, [
            ...
            mw.config({
              others: {
                sandbox: (t) =>
                  Sw(e, t, { onOpen: () => $p.on(t), onClose: () => $p.off(t) })
              }
            }),
            kp.config({
              mode: 'special',
            ...
            i = (o, n) => {
              Zd.setValue(
                ...
                ((e, t) => {
                  ...
                  return W(se(e), (e) =>
                    V(o, (t) => _e(e.name.toLowerCase(), `.${t.toLowerCase()}`))
                  )
                })(n, t)
              ),
                wr(o, Fx, { name: e.name })
            ...
            { uiMothership: x, sink: w } = (() => {
              const t = Rf(e),
                ...
                r = {
                  ...
                  behaviours: cl([id.config({ useFixed: () => n.isDocked(m) })])
                },
                a = {
